<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proforma.aspx.cs" Inherits="ExternalTrade.Proforma" %>
...
function varisError() {
  ...
  <script>
    ...
    <script>
        ...
        function HSCodeGirilmedi() {
            swal({
                title: "DİKKAT", text: "HC Code Alanı Boş Geçilemez", type: "warning"
            });
        }
    </script>
    <script>
...
<body>
    <form id="form1" runat="server">
     ...
     <asp:Button ID="btnProformaOnayi" runat="server" Text="ONAYA SUN" CssClass="btn btn-primary" Height="40px" BackColor="Blue" ForeColor="White" OnClick="Button1_Click" />
    ...
    <div id="pdf">
        ...
        <%
            ...
            baslikoku.Close();
            SqlCommand baslikcek2 = new SqlCommand("select PO,ProformaInvoiceDate,ProformaInvoiceNo,HSCODE,ISNULL(HSCODE2,'') as HSCODE2,ISNULL(HSCODE3,'') as HSCODE3,ISNULL(HSCODE4,'') as HSCODE4,ProformaSpecialNote from AllOperationDocuments where TeklifNo='" + Request.QueryString["teklifno"] + "'", con);
        ...
        <%
            ...
            <tr>
                <td colspan="8" style="text-align: center; font-size: 40px;" class="auto-style1"><span style="text-align: center;"><b> PROFORMA INVOICE</b></span></td>
            </tr>
              <tr>
             ...
             <tr>
                <td colspan="3" class="cizgi yaziboyutu" style="height:15px;"><span class="kaydiryirmi"><b><%=firma[0] %>
             ...
             <tr>
              ...
              <td class="kaydiryirmi cizgi yaziboyutu" colspan="3" style="height:15px;"><b><span><%=baslik[11] %>
                ...
                <%}
                  ...
                  <tr>
                <td class="cizgi baslik orta" style="height:15px;" colspan="4"><span style="text-align: center; margin-left: 80px; height:15px;"><b>BANK DETAILS</b></span></td>
   ...
   <tr>
    ...
    <asp:Panel ID="PANEL" runat="server">
       ...
       <asp:Button ID="Button1" runat="server" Text="ONAYA SUN" CssClass="btn btn-primary" Height="40px" BackColor="Blue" ForeColor="White" OnClick="Button1_Click" />
       <asp:Button ID="btnpdf2" runat="server" Text="PDF" OnClick="btnPrintDiv_Click" CssClass="btn btn-warning" BackColor="Orange" ForeColor="White" Height="40px" />
    <a href="Home.aspx" class="btn btn-success" style="height:40px; background-color:green;color:white">ANA SAYFA</a>
        </div>
    </asp:Panel>
