<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="OperationCommercialInvoice.aspx.cs" Inherits="ExternalTrade.OperationCommercialInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script>
        function Dikkat() {
            swal({
                title: "DİKKAT", text: "Bu Sipariş İçin Commercial Invoice oluşturmak İstiyorsanız Lütfen Yöneticinizden Onay Alınız", type: "warning"

            });
        }
        function onaybekliyor() {
            swal({
                title: "DİKKAT", text: "Bu Sipariş Yönetici Onayı Bekliyor", type: "warning"

            });
        }
    </script>
            <!-- /.modal -->
          <div id="mymodal" class="modal fade bs-example-modal-center" tabindex="-1" role="dialog" aria-labelledby="myCenterModalLabel" aria-hidden="true" style="display: none;">
                                    ...
                                    <div class="card-body p-4">
                                         ...
                                         <div class="form-group mb-0 text-center">
                                             <asp:Button ID="btn1" runat="server" OnClick="btn1_Click"  CssClass="btn btn-success" Text="KAYDET" Height="40px"/>
      ...
      <div class="row" style:"width:100%;">
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group row">
                      ...
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                          <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Theme="Moderno" CssClass="GridTemplate"  KeyFieldName="TeklifNo">
        ...
        <%--   <asp:Button ID="btnRapor" runat="server" Text="DETAYLAR" CssClass="btn btn-danger"  Height="40px" OnClick="btnRapor_Click"/>--%>
          <%--  <a href="CommercialInvoiceOperation.aspx" class="btn btn-primary" style="height:40px;" data-toggle="modal" data-target="#mymodal">COMMERCIAL INVOICE OLUŞTUR</a>--%>
                 <asp:Button ID="btnCommercila" runat="server" Text="COMMERCIAL INVOICE OLUSTUR" Height="40px" CssClass="btn btn-success" OnClick="btnCommercila_Click" />
