...
{
    public partial class OnayBekleyenTeklifler : System.Web.UI.Page
    {
        ...
        protected void btnRapor_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("OnayBekleyenTekliflerDetay.aspx?teklifno=" + teklifno + "");
            }
            catch
            {
        ...
        {
            ASPxGridViewExporter1.WriteXlsToResponse("Onay_Bekleyen_Teklifler_Listesi" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }
