...
{
    public partial class Proforma_Operation : System.Web.UI.Page
    {
        ...
        protected void btnProformaOnayi_Click(object sender, EventArgs e)
        {
            if (db.CommerciAlInvoice(Request.QueryString["teklifno"], UserData.Id) == 1)
            {
                Response.Redirect("CommercialInvoiceOperation.aspx?teklifno=" + Request.QueryString["teklifno"] + "");
            }
        }
