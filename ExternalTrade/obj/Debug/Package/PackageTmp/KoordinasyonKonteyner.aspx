<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="KoordinasyonKonteyner.aspx.cs" Inherits="ExternalTrade.KoordinasyonKonteyner" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
 <div class="row" style:"width:100%;">
   <style type="text/css">
        ...
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group ">
                      ...
                      <div style="width:100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                              ...
                              <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="SİPARİŞ NO" Width="100%" Theme="Office2003Blue" CssClass="GridTemplate" >
                                            ...
                                            <Settings ShowFilterRow="True" ShowHeaderFilterButton="True" VerticalScrollBarMode="Auto" VerticalScrollableHeight="300" />
                                            <Settings ShowFilterRowMenu="true" HorizontalScrollBarMode="Auto"/>
             ...
             <div class="btn-group">
           <a href="KoordinasyonKonteyner.aspx" class="btn btn-success" style="height:40px;">YENİLE</a>
 <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="KoordinasyonKonteyner" SelectCommandType="StoredProcedure">
     <SelectParameters>
