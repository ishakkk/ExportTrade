<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Proforma_Operation.aspx.cs" Inherits="ExternalTrade.Proforma_Operation" %>
 ...
 <script>
     function successAlert() {
         swal(
             ...
             ).then(function () { window.location = 'Proforma_Operation.aspx?teklifno=<%=Request.QueryString["teklifno"]%>&gelen=1' });
     }
...
function varisError() {
  ...
  <script>
    ...
    <script>
        ...
        function PO() {
            swal({
                title: "İŞLEM TAMAMLANDI", text: "PO BİLGİSİ GÜNCELLENDİ", type: "success"
            }).then(function () { window.location = 'Proforma_Operation.aspx?teklifno=<%=Request.QueryString["teklifno"]%>&gelen=1' });
        }
...
<body>
    <form id="form1" runat="server">
       ...
       <div style="text-align: center;height:10px;">
          ...
          <asp:Button ID="btnPrintDiv" runat="server" Text="PDF" CssClass="btn btn-warning" OnClick="btnpdf2_Click" BackColor="Orange" ForeColor="White" Height="40px"/>
           <a href="Home.aspx" class="btn btn-success" style="height:40px; background-color:green;color:white">ANA SAYFA</a>
             <asp:Button ID="btnProformaOnayi" runat="server" Text="COMMERCIAL INVOICE" CssClass="btn btn-primary" Height="40px" BackColor="Blue" ForeColor="White" OnClick="btnProformaOnayi_Click"  />
    </div>
         </asp:Panel>
        ...
        <div class="modal fade bs-example-modal-center" id="mdlkalkis" tabindex="-1" role="dialog" aria-labelledby="myCenterModalLabel" aria-hidden="true" style="display: none;">
            ...
            <div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">KAPAT</button>
                                                    <asp:Button ID="btnSpecialNoteUpdate" runat="server" Text="GÜNCELLE" CssClass="btn btn-primary" OnClick="Button3_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
         <div class="modal fade" id="exampleModalScrollable3" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h4 class="modal-title" id="exampleModalScrollableTitle3">PO</h4>
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        <span aria-hidden="true">&times;</span>
                                                    </button>
                                                </div>
                                                <div class="modal-body">
                                                   <div>
                                                      PO
                                                       ...
                                                       <asp:TextBox ID="txtPO" runat="server" CssClass="form-control" TextMode="MultiLine"></asp:TextBox>
                                                   </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">KAPAT</button>
                                                    <asp:Button ID="Button3" runat="server" Text="GÜNCELLE" CssClass="btn btn-primary" OnClick="btnSpecialNoteUpdate_Click" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
           <div class="modal fade" id="exampleModalScrollable2" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">KAPAT</button>
                                                    <asp:Button ID="Button2" runat="server" Text="GÜNCELLE" CssClass="btn btn-primary" OnClick="Button1_Click"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="pdf">
        ...
        <%
            ...
            baslikoku.Close();
            SqlCommand baslikcek2 = new SqlCommand("select PO,ProformaInvoiceDate,ProformaInvoiceNo,HSCODE,HSCODE,ISNULL(HSCODE2,'') as HSCODE2,ISNULL(HSCODE3,'') as HSCODE3,ISNULL(HSCODE4,'') as HSCODE4,ProformaSpecialNote from AllOperationDocuments where TeklifNo='" + Request.QueryString["teklifno"] + "'", con);
            ...
            SqlCommand foott = new SqlCommand("select case when Palet<> 'YOK'  then 'PALETLİ' when BBTipi <> 'YOK' and Palet='YOK' then 'BBLİ' end PaletDegil, KonteynerBulkSecimi, REPLACE(REPLACE(o.Vade,'Peşin','CASH IN ADVANCE'),'Gün','DAYS AFTER B/L') as Vade,case when o.KalkisLimani='MIP' Then 'MIP (MERSIN INTERNATIONAL PORT)' when o.KalkisLimani='Limak' then 'ISKENDERUN LIMAK' when KalkisLimani='YOK' then '' end as KalkisLimani,REPLACE(o.VarisLimani,'YOK','') as VarisLimani,REPLACE(o.TeklifTipi,'YOK','') as TeklifTipi,CAST(SUM(o.buUrununSiparisTonaji*1000) as decimal(18,0)) as MIKTAR,CAST(SUM(distinct SiparistekiKonteynerSayisi) as int) as Konteyner,case when KalkisLimani='MIP' then '' when KalkisLimani='Limak' then '' else UPPER(KalkisLimani)  end as Sehir,case  when EkipmanTuru='40 DV' then  CONVERT(nvarchar ,CAST(SUM(distinct SiparistekiKonteynerSayisi) as int))+'X' +' 40 HC' when EkipmanTuru='20 DV' then CONVERT(nvarchar ,CAST(SUM(distinct SiparistekiKonteynerSayisi) as int))+'X' +' 20 DC'  end as Ekipman, case when EkipmanTuru='20 DV' then 20*30 when EkipmanTuru='40 DV' then 40*30 else 0 end as Gross,FobVisible,PaymentTerms  from Orders o where TeklifNo=@p1 group by o.Vade,o.KalkisLimani,o.VarisLimani,o.TeklifTipi,o.EkipmanTuru,FobVisible,KonteynerBulkSecimi,PaymentTerms ,Palet,BBTipi", con);
        ...
        <%
           ...
           <%
                if (baslik[4] == "$")
                {
                    ...
                    <%
                       ...
                       foreach(DataRow dr in dt.Rows)
                        ...
                        for (int i = Convert.ToInt32(Session["ks"])+1; i <= 8; i++)
                    {%>
                        <tr>
                ...
                <td style="text-align: center; width: 50px;height:5px;" class="cizgi renk baslik"><b><%=i.ToString() %></b> </td>
                <td style="text-align: center; width: 500px;height:5px;" class="cizgi renk">&nbsp;</td>
                <td style="text-align: center; width: 50px;height:5px;" class="cizgi renk">&nbsp;</td>
                <td style="text-align: center; width: 150px;height:5px;" class="cizgi renk">&nbsp;</td>
                <td style="text-align: center; width: 200px;height:5px;" class="cizgi renk">&nbsp;</td>
                <td style="text-align: center; width: 250px;height:5px;" class="cizgi renk">&nbsp;</td>
                             <td style="text-align: center; width: 250px;height:5px;" class="cizgi renk">&nbsp;</td>
            </tr>
                <%}
                     }
           ...
           <tr>
                ...
                else  if (baslik[4] == "TL")
                {
                    ...
                    <%
                       ...
                       foreach(DataRow dr in dt.Rows)
                        ...
                        kayitsira++;
                        Session["ks"] = kayitsira;
                        total = total + Convert.ToDouble(dr["Total2"]);
                    }
                        for (int i = Convert.ToInt32(Session["ks"]); i <= 8; i++)
                    {%>
                        <tr>
                ...
                <%}
                    ...
                    {%>
                     ...
                     <%
                        ...
                        <%
                            kayitsira++;
                            Session["ks"] = kayitsira; total = total + Convert.ToDouble(dr["Total2"]);
                        }
                          for (int i = Convert.ToInt32(Session["ks"]); i <= 8; i++)
                    {%>
                        <tr>
            ...
            <tr>
                ...
                <td class="cizgi baslik" style="text-align: center; height:20px;"><span ><b> ₺<%=total.ToString("n2") %></b></span></td>
            </tr>
           <tr>
                <td colspan="7" class="cizgi baslik orta" style="height:20px;"><span style="text-align: center; margin-left: 40px; height:20px;"><b><a href="#" style="color:black; text-decoration:none;"  data-toggle="modal" data-target="#staticBackdrop">SAY#<%=foot[9] %>ONLY#</a></b></span></td>
           ...
           <tr>
            ...
            <%}
                   else if (kayitsayisi > 8 && kayitsayisi <= 16)
             {%>
                  <table class=<%if (baslik[6] == "NİĞTAŞ ANONİM ŞİRKETİ")
                       {%> "arkaplannigtas" <%}
                                 else if (baslik[6] == "MİKROKAL ANONİM ŞİRKETİ")
          ...
          <%
                    ...
                    <%
                       ...
                       foreach(DataRow dr in dt.Rows)
                        ...
                        Session["ks"] = kayitsira;
                         ...
                         for (int i = Convert.ToInt32(kayitsira); i <= 8; i++)
                    {%>
                        <tr>
                ...
                <%}
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 1;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_USD_1_8", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                        altbilgi.SelectCommand = alt;
          ...
          <%-- <tr>
            ...
            <%}
                ...
                <%}
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 1;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_TL_1_8", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@dolar", Convert.ToDouble(baslik[9]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
            ...
            <%}
                ...
                <%}
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 1;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_EUR_1_8", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@parite",Convert.ToDouble(baslik[5]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
           ...
           <tr>
            ...
            %>
                 ...
                 for (int i = 0; i <= 20;i++ ){%>
                       <tr>
                <td colspan="7" class="cizgi baslik orta" style="height:20px;">&nbsp;</td>
          ...
          <%
                if (baslik[4] == "$")
                {
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 9;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_USD_9_16", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                        altbilgi.SelectCommand = alt;
                   ...
                   else  if (baslik[4] == "TL")
                {
                    ...
                    <%
                       ...
                       foreach(DataRow dr in dt.Rows)
                        ...
                        for (int i = Convert.ToInt32(Session["ks"]); i <= 18 - Convert.ToInt32(sws3.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 9;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_TL_9_16", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@dolar", Convert.ToDouble(baslik[9]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                    ...
                    for (int i = Convert.ToInt32(Session["ks"]); i <= 18 - Convert.ToInt32(sws4.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
            ...
            <%}
                ...
                else if (baslik[4] == "€")
                {
                    ...
                    <%
                        ...
                        SqlCommand sws5 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 9 and 17", con);
                        for (int i = Convert.ToInt32(Session["ks"]); i <= 18 - Convert.ToInt32(sws5.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 9;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_EUR_9_16", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@parite",Convert.ToDouble(baslik[5]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                    ...
                    SqlCommand sws6 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 9 and 17", con);
                    for (int i = Convert.ToInt32(Session["ks"]); i <= 18 - Convert.ToInt32(sws6.ExecuteScalar()); i++)
  ...
  <%-- <tr>
              ...
              <td class="cizgi yaziboyutu" style="height:15px;" colspan="3">
                  <%
                SqlCommand pakettipi = new SqlCommand("select Case  when TorbaTipi='YOK' then '' when TorbaTipi <> 'YOK' then Convert(varchar, TorbaAgirligi)+' '+TorbaTipi end as Torba ,case  when BBTipi='YOK' then '' when BBTipi <> 'YOK' then BBTipi end as BigBag, case when REPLACE(Palet,'YOK',0)=0 then '' when Palet <> 'YOK' then 'Pallettized'      end as Palet,'Streched'   as Strec,case when Palet <> 'YOK' then Palet when REPLACE(Palet ,'YOK',0)=0 then case when REPLACE(BBAgirligi,'YOK',0) <> 0 then BBAgirligi when REPLACE(BBAgirligi ,'YOK',0)=0 then '' end end as UniteAgirlik,case when Palet <> 'YOK' then CAST(SUM(buUrununSiparisTonaji*1000) as int)/CAST(Palet as int) when REPLACE(Palet,'YOK',0)=0 then case when BBTipi <> 'YOK' then CAST(SUM(buUrununSiparisTonaji*1000) as int)/CAST(BBAgirligi as int) when BBTipi ='YOK' then 0 end end as PaketSayisi   from Orders where TeklifNo=@p1 group by TorbaTipi,TorbaAgirligi,BBTipi,BBAgirligi,Palet", con);
                      pakettipi.Parameters.AddWithValue("@p1",Request.QueryString["teklifno"]);
                      SqlDataAdapter da4 = new SqlDataAdapter();
                      da4.SelectCommand = pakettipi;
                      DataTable dt4 = new DataTable();
            ...
            <tr>
                <td class="cizgi yaziboyutu" style="height:15px;"><b><span class="kaydiryirmi">NO OF PACKAGE</span></b></td>
             <td class="cizgi yaziboyutu" style="height:15px;" colspan="3"><b><span><%=paketsayisi %>&nbsp;<%=pakettipi10 %></span></b></td>
            </tr>
             <tr>
                <td class="cizgi yaziboyutu" style="height:15px;"><b><span class="kaydiryirmi">NO OF FCL</span></b></td>
              <td class="cizgi yaziboyutu" style="height:15px;" colspan="3"><b><span> <%=foot[7] %></span></b></td>
            ...
            <tr>
             ...
             <tr>
              ...
              <td class="kaydiryirmi cizgi yaziboyutu" colspan="3" style="height:15px;"><b><span><%=baslik[11] %></span></b></td>
                  ...
                  <tr>
                <td class="cizgi yaziboyutu orta" style="height:15px;" colspan="4"><b><span class="kaydiryirmi">BANK DETAILS</span></b></td>
                <td class="cizgi yaziboyutu orta" colspan="3" rowspan="6"><b><asp:Image ID="Image6" runat="server" Height="100"/></b></td>
            </tr>
              <tr>
                <td class="cizgi yaziboyutu" style="height:15px;"><b><span class="kaydiryirmi">BENEFICARY</span></b></td>
             ...
             <tr>
                 <td class="cizgi orta yaziboyutu" colspan="4" style="height:90px; width:600px; vertical-align:top"><b><span class="kaydiryirmi"> SIGNATURE AND STAMP</span></b><br />
                     <span style="padding-top:50%">
                         <asp:Image ID="Image7" runat="server" CssClass="imzakase" />
                     </span>
                 </td>
                   <td class="cizgi orta yaziboyutu" colspan="4" style="height:90px;vertical-align:top;width:600px;"><b><span class="kaydiryirmi"> SIGNATURE AND STAMP</span></b></td>
             </tr>--%>
         ...
         <table class=<%if (baslik[6] == "NİĞTAŞ ANONİM ŞİRKETİ")
          ...
          <%
                if (baslik[4] == "$")
                {
                    ...
                    SqlCommand sws2 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='"+Request.QueryString["teklifno"]+"' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 9 and 16", con);
                    for (int i = Convert.ToInt32(Session["ks"]); i <= 18 - Convert.ToInt32(sws2.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
          ...
          <%
                if (baslik[4] == "$")
                {
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 17;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_USD_17_25", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                        altbilgi.SelectCommand = alt;
                    ...
                    SqlCommand sws2 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='"+Request.QueryString["teklifno"]+"' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 18 and 25", con);
                   ...
                   else  if (baslik[4] == "TL")
                {
                    ...
                    <%
                       ...
                       foreach(DataRow dr in dt.Rows)
                        ...
                        SqlCommand sws3 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 18 and 25", con);
                        for (int i = Convert.ToInt32(Session["ks"]); i <= 26 - Convert.ToInt32(sws3.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 17;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_TL_17_25", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@dolar", Convert.ToDouble(baslik[9]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                    ...
                    for (int i = Convert.ToInt32(Session["ks"]); i <= 26 - Convert.ToInt32(sws4.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
            ...
            <%}
                ...
                else if (baslik[4] == "€")
                {
                    ...
                    <%
                        ...
                        SqlCommand sws5 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 17 and 25", con);
                        for (int i = Convert.ToInt32(Session["ks"]); i <= 26 - Convert.ToInt32(sws5.ExecuteScalar()); i++)
                    {%>
                         <tr>
                            <td style="text-align: center; width: 50px; height:25px;" class="cizgi renk"><b><%=i %></b></td>
                            <td style="text-align: left; width: 500px;height:25px;" class="cizgi renk baslik"><b>&nbsp;</b> </td>
                    ...
                    {%>
                     ...
                     <%
                        int kayitsira = 17;
                        SqlCommand alt = new SqlCommand("Sales_Quotation_Fob_EUR_17_25", con);
                        alt.Parameters.AddWithValue("@TeklifNo",Request.QueryString["teklifno"]);
                        alt.Parameters.AddWithValue("@parite",Convert.ToDouble(baslik[5]));
                        alt.CommandType = CommandType.StoredProcedure;
                        SqlDataAdapter altbilgi = new SqlDataAdapter();
                    ...
                    SqlCommand sws6 = new SqlCommand("with myReslt(sira,Aciklama,Urun,buUrununSiparisTonaji,KalemSatisFiyati,TotalFiyat)as(select ROW_NUMBER() OVER( order by UrunAnaGrup ) as sira, case when UrunAnaGrup='18.TALK' then 'TALC' when UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when UrunAnaGrup='15.HİDROFİL' or UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama, o.Urun,CONVERT(varchar, FORMAT(CAST(SUM(buUrununSiparisTonaji) as decimal(18,3)),'###,###,###.00','de-de')) as buUrununSiparisTonaji,CONVERT(varchar,FORMAT(CAST(KalemSatisFiyati as decimal(18,3)),'###,###,###.00','de-de')) as KalemSatisFiyati, CONVERT(varchar,FORMAT(CAST(SUM(buUrununSiparisTonaji)*(KalemSatisFiyati) as decimal(18,3)),'###,###,###.00','de-de')) as TotalFiyat from Orders o  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' group by o.Urun,o.KalemSatisFiyati,o.UrunAnaGrup)select COUNT(*) from myReslt where sira between 18 and 25", con);
                    for (int i = Convert.ToInt32(Session["ks"]); i <= 26 - Convert.ToInt32(sws6.ExecuteScalar()); i++)
   ...
   <tr>
              ...
              <td class="cizgi yaziboyutu" style="height:15px;" colspan="3">
                ...
                SqlCommand pakettipi3 = new SqlCommand("select Case  when TorbaTipi='YOK' then '' when TorbaTipi <> 'YOK' then Convert(varchar, TorbaAgirligi)+' '+REPLACE(REPLACE(TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba ,case  when BBTipi='YOK' then '' when BBTipi <> 'YOK' then BBTipi end as BigBag, case when REPLACE(Palet,'YOK',0)=0 then '' when Palet <> 'YOK' then 'Pallettized'      end as Palet,'Streched'   as Strec,case when Palet <> 'YOK' then Palet when REPLACE(Palet ,'YOK',0)=0 then case when REPLACE(BBAgirligi,'YOK',0) <> 0 then BBAgirligi when REPLACE(BBAgirligi ,'YOK',0)=0 then '' end end as UniteAgirlik,case when Palet <> 'YOK' then CAST(SUM(buUrununSiparisTonaji*1000) as int)/CAST(Palet as int) when REPLACE(Palet,'YOK',0)=0 then case when BBTipi <> 'YOK' then CAST(SUM(buUrununSiparisTonaji*1000) as int)/CAST(BBAgirligi as int) when BBTipi ='YOK' then 0 end end as PaketSayisi   from Orders where TeklifNo=@p1 group by TorbaTipi,TorbaAgirligi,BBTipi,BBAgirligi,Palet", con);
                      ...
                      SqlDataAdapter da45 = new SqlDataAdapter();
                      da45.SelectCommand = pakettipi3;
                      DataTable dt45 = new DataTable();
                      da45.Fill(dt45);
                     foreach(DataRow p in dt45.Rows)
                      {%>
                          <span><b><%=p["Torba"].ToString() %>&nbsp;&nbsp;<%=p["UniteAgirlik"].ToString() +"KGS"%>&nbsp;&nbsp;<%=p["BigBag"].ToString() %>&nbsp;<%=p["Palet"].ToString() %>&nbsp;<%=p["Strec"].ToString() %>&nbsp;(<%=p["PaketSayisi"].ToString() %> PCS)</b></span>  
                          <br />
                      <%
            ...
            <tr>
              ...
              <td class="cizgi yaziboyutu" style="height:15px;" colspan="3">
                ...
                SqlCommand unit3 = new SqlCommand("select  case when Palet <> 'YOK' then Palet  when REPLACE(Palet,'YOK',0) =0 then case when REPLACE(BBAgirligi,'YOK',0) <> 0 then BBAgirligi  when REPLACE(BBAgirligi ,'YOK',0)=0 then '' end end as UniteAgirlik, case when  KonteynerBulkSecimi <> 'RORO' then   case when Palet <> 'YOK' then CAST(Palet as int)+30 when REPLACE(Palet ,'YOK',0)=0 then case when REPLACE(BBAgirligi,'YOK',0) <> 0 then case  when Ulke ='Cezayir' then CAST(BBAgirligi as int)+10 when Ulke='Rusya' then CAST(BBAgirligi as int)+3 else CAST(BBAgirligi as int)+10 end when REPLACE(BBAgirligi,'YOK',0) =0 then '' end end else  case when Palet <> 'YOK' then CAST(Palet as int)+30 when REPLACE(Palet ,'YOK',0)=0 then case when REPLACE(BBAgirligi,'YOK',0) <> 0 then case  when Ulke ='Cezayir' then CAST(BBAgirligi as int)+10 when Ulke='Rusya' then CAST(BBAgirligi as int)+3 else CAST(BBAgirligi as int)+10 end when REPLACE(BBAgirligi,'YOK',0) =0 then '' end end end as Brut from Orders where TeklifNo=@p1 group by Palet,BBTipi,BBAgirligi,Ulke,KonteynerBulkSecimi", con);
                      ...
                      SqlDataAdapter da56 = new SqlDataAdapter();
                      da56.SelectCommand = unit3;
                      DataTable dt56 = new DataTable();
                      da56.Fill(dt56);
                      
                      foreach(DataRow un in dt56.Rows)
                      {%>
                          <span><b>&nbsp;<%=un["UniteAgirlik"].ToString()%>&nbsp;KGS NET WEIGHT</b></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span><b><%=un["Brut"].ToString() %> KGS GROSS WEIGHT</b></span>
                          <br />
                      <%}                                                        
            ...
            <tr>
             ...
             <tr>
              ...
              <td class="kaydiryirmi cizgi yaziboyutu" colspan="3" style="height:15px;"><b><span><%=baslik[11] %>
                ...
                <%}
                  ...
                  <tr>
                <td class="cizgi yaziboyutu orta" style="height:15px;" colspan="4"><b><span class="kaydiryirmi">BANK DETAILS</span></b></td>
                <td class="cizgi yaziboyutu orta" colspan="3" rowspan="6"><b><asp:Image ID="Image10" runat="server" Height="100"/></b></td>
            </tr>
              <tr>
                <td class="cizgi yaziboyutu" style="height:15px;"><b><span class="kaydiryirmi">BENEFICARY</span></b></td>
              <td class="cizgi yaziboyutu" style="height:15px;" colspan="3"> <b><span><%=baslik[6] %></span></b></td>
             ...
             <tr>
                 <td class="cizgi orta yaziboyutu" colspan="4" style="height:90px; width:600px; vertical-align:top"><b><span class="kaydiryirmi"> SIGNATURE AND STAMP</span></b><br />
                     <span style="padding-top:50%">
                         <asp:Image ID="Image11" runat="server" CssClass="imzakase" />
                     </span>
                 </td>
                   <td class="cizgi orta yaziboyutu" colspan="4" style="height:90px;vertical-align:top;width:600px;"><b><span class="kaydiryirmi"> SIGNATURE AND STAMP</span></b></td>
             </tr>
    ...
    <asp:Panel ID="PANEL" runat="server">
       ...
       <asp:Button ID="btnpdf2" runat="server" Text="PDF" OnClick="btnpdf2_Click" CssClass="btn btn-warning" BackColor="Orange" ForeColor="White" Height="40px" />
    <a href="Home.aspx" class="btn btn-success" style="height:40px; background-color:green;color:white">ANA SAYFA</a>
                <asp:Button ID="Button1" runat="server" Text="COMMERCIAL INVOICE" CssClass="btn btn-primary" Height="40px" BackColor="Blue" ForeColor="White" OnClick="btnProformaOnayi_Click"  />
        </div>
    </asp:Panel>
