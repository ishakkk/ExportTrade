<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="KonsimentoOperation.aspx.cs" Inherits="ExternalTrade.KonsimentoOperation" %>
...
<head>
    ...
    <style>
        color-adjust: exact; -webkit-print-color-adjust: exact; .cizgi {
            border: groove;
        }
    ...
    <script type="text/javascript">
        ...
        function successAlert() {
            ...
            }).then(function () { window.location = 'KonsimentoOperation.aspx?teklifno=<%=Request.QueryString["teklifno"]%>&gelen=1' });
        }
        function FCLNO() {
            swal({
    ...
    <form id="form1" runat="server">
        ...
        <div id="pdf" class="table-responsive">
            ...
            <%
                ...
                agirlikoku.Close();
                //SqlCommand faturacek = new SqlCommand("select OperationInvoice,OperationInvoiceDate from AllOperationDocuments  where TeklifNo=@p1", con);
                ...
                //{
                //    if (faturaoku["OperationInvoice"].ToString() == "" || faturaoku["OperationInvoice"].ToString() == null)
                //    {
                //        SqlCommand faturacek2 = new SqlCommand("select ISNULL(INV.FICHENO,'0') as fisno,ISNULL(CONVERT(varchar, INV.DATE_),'00.00.0000') as Tarih from Orders o left outer join DTBSSRVR.TIGERDB.dbo.LG_219_01_ORFICHE FC on o.SiparisNo=FC.FICHENO left outer join DTBSSRVR.TIGERDB.dbo.LG_219_01_STLINE ST on ST.ORDFICHEREF=FC.LOGICALREF left outer join DTBSSRVR.TIGERDB.dbo.LG_219_01_INVOICE INV on ST.INVOICEREF=INV.LOGICALREF where o.TeklifNo=@p1", con);
                ...
                //    else
                //    {
                //        fatura[0] = faturaoku["OperationInvoice"].ToString();
                //        fatura[1] = faturaoku["OperationInvoiceDate"].ToString();
                //    }
                //}
                //faturaoku.Close();
                ...
                baslikoku.Close();
                SqlCommand baslikcek2 = new SqlCommand("select PO,KonsimentoSpecialNote,OperationInvoice,OperationInvoiceDate,FreeTime from AllOperationDocuments where TeklifNo='" + Request.QueryString["teklifno"] + "'", con);
                ...
                SqlCommand b = new SqlCommand("select BOOKINGNUMBER from AllOperationDocuments where TeklifNo=@p1", con);
                b.Parameters.AddWithValue("@p1", Request.QueryString["teklifno"]);
                booking = Convert.ToString(b.ExecuteScalar());
                if (booking == null || booking == "")
                {
                    SqlCommand bookingcek = new SqlCommand("select book.BOOKINGNO as booking from Orders o left outer join DTBSSRVR.TIGERDB.dbo.LG_219_01_ORFICHE FC on o.SiparisNo=FC.FICHENO left outer join  DTBSSRVR.TIGERDB.dbo.LG_XT1012001_219  book on FC.LOGICALREF=book.PARLOGREF where o.TeklifNo=@p1 and book.BOOKINGNO is not null", con);
                    bookingcek.Parameters.AddWithValue("@p1", Request.QueryString["teklifno"]);
                    SqlCommand gu = new SqlCommand("update AllOperationDocuments set BOOKINGNUMBER='" + Convert.ToString(bookingcek.ExecuteScalar()) + "' where TeklifNo='" + Request.QueryString["teklifno"] + "'", con);
                ...
                SqlCommand konsimentokayitsayisicek = new SqlCommand("select COUNT(distinct FCLNO) from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli'", con);
                int konsimentokayitsayisi = Convert.ToInt32(konsimentokayitsayisicek.ExecuteScalar());
                SqlCommand paketsayisicek = new SqlCommand("select ISNULL(SUM(PaletSayisi),0) as sayi from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli'", con);
            ...
            <div id="myModal2" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h4 class="modal-title" id="myModalLabel3">CARİ BİLGİLERİ</h4>
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                        </div>
                        <div class="modal-body">
                            <div>
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="Button5" runat="server" Text="KAYDET" CssClass="btn btn-primary" OnClick="Button5_Click1" />
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta baslik"><b><a href="KonsimentoUrunler.aspx?teklifno=<%=Request.QueryString["teklifno"] %>" style="color: black; text-decoration: none;">PRODUCT</a></b></td>
                ...
                int kolonsayisi = 1;
                SqlCommand fcl1 = new SqlCommand("select COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + " ' and SiparisTipi='Tekli' group by FCLNO", con);
                ...
                <tr>
                    <td style="height: 10%; width: 20%; text-align: center" class="cizgi orta yaziboyutu"><b><%=kolonsayisi %></b></td>
                    <%
                        SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu and o.TeklifNo=k.TeklifNo  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and  k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'  group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Id order by o.Id asc", con);
                    ...
                    <%
                        SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,kp.PaletSayisi as PALET   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,kp.MamulKodu,kp.PaletSayisi,o.Id order by o.Id asc", con);
                    ...
                    %>
                    <%
                                    SqlCommand PCSCEK = new SqlCommand("select distinct case when o.Palet <> 'YOK' then 'PALLETS' else 'NO PALLETS'   end  as PCS from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu and o.TeklifNo=k.TeklifNo where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'", con);
                    ...
                    %>
                    <%
                                    SqlCommand netbrutcek = new SqlCommand("select CAST(SUM(kp.KonteynerdakiTonaj) as decimal(18,0)) as NET,case   when o.Palet <> 'YOK' then CAST(SUM(PaletSayisi*30) as int) when o.Palet ='YOK' then CAST(SUM(PaletSayisi*10) as int) end as BRUT   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by o.Palet,o.BBAgirligi", con);
                ...
                <tr style="overflow-y:scroll;">
                    ...
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu">
                        <%
                             SqlCommand uruncek = new SqlCommand("select  case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.YediyuzluKod,o.Id order by o.Id asc", con);
                             SqlDataReader urunoku = uruncek.ExecuteReader();
                             while (urunoku.Read())
                             {%>
                    ...
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta yaziboyutu">
                        <%
                             ...
                             SqlCommand paketcek = new SqlCommand("select Case  when o.TorbaTipi='YOK' then '' when o.TorbaTipi <> 'YOK' then Convert(varchar, o.TorbaAgirligi)+' '+REPLACE(REPLACE(o.TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba,case  when o.BBTipi='YOK' then '' when o.BBTipi <> 'YOK' then CONVERT(varchar,o.BBAgirligi)+' '+o.BBTipi end as BigBag, case when o.Palet='YOK' then '' when o.Palet <> 'YOK' then 'Pallettized'  end as Palet,'Streched' as Strec,Case when Palet <> 'YOK' then CAST(Palet as int) when Palet ='YOK' then CAST(BBAgirligi as int)     end as NET from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by o.TorbaTipi,o.TorbaAgirligi,o.BBTipi,o.BBAgirligi,o.Palet,k.MamulKodu,o.Id order by o.Id asc", con);
                             SqlDataReader paketoku = paketcek.ExecuteReader();
                             while (paketoku.Read())
                             {%>
                    ...
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu">
                        <%
                        SqlCommand palettcek = new SqlCommand("select o.Id, kp.FCLNO,kp.PaletSayisi as PALET   from KonsimentoProduct kp inner join Orders o on o.YediyuzluKod=kp.MamulKodu and o.TeklifNo=kp.TeklifNo  where kp.TeklifNo='" + Request.QueryString["teklifNo"] + "' and kp.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' order by o.Id asc", con);
                                                 SqlDataReader palettoku = palettcek.ExecuteReader();
                                                 while (palettoku.Read())
                                                 {
                                                     string a = palettoku["PALET"].ToString();
                                                     %>
                    ...
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu">
                        <%
                                    SqlCommand PCSCEK = new SqlCommand("select distinct case when o.Palet <> 'YOK' then 'PALLETS' else 'NO PALLETS'   end  as PCS from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'", con);
                                    SqlDataReader PCSOKU = PCSCEK.ExecuteReader();
                                    while (PCSOKU.Read())
                                    {%>
                ...
                totaldegerler[0] = 0;
                SqlCommand pcek = new SqlCommand("select COUNT(distinct k.FCLNO), case when o.Palet='YOK' then 0 when Palet <> 'YOK' then COUNT(distinct k.FCLNO)*20    end as Palet from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.SiparisTipi='Tekli' group by o.Palet", con);
                ...
                SqlCommand netttotal = new SqlCommand("select ISNULL(SUM(k.KonteynerdakiTonaj),0) as NET  from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu and k.TeklifNo=o.TeklifNo where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.SiparisTipi='Tekli'", con);
                totaldegerler[1] = Convert.ToDouble(netttotal.ExecuteScalar());
                SqlCommand fclfarklı = new SqlCommand("Konsimento_Gros_Total_Tekli", con);
                fclfarklı.Parameters.AddWithValue("@TeklifNo", Request.QueryString["teklifno"]);
                ...
                <tr>
                    ...
                    <td class="cizgi yaziboyutu" style="vertical-align: top; word-break: break-all;" colspan="3" rowspan="4"><b>
                        <textarea readonly="readonly" class="yaziboyutu orta" rows="9" cols="9" style="background-color: none; background: transparent; overflow: auto; border-color: none; width: 100%; height: 100%;"><%=baslik[7]%></textarea></b></td>
                </tr>
                ...
                {%>
                    ...
                    <td class="cizgi yaziboyutu orta" colspan="3" rowspan="3"><b><span>
                        <asp:Image ID="img_yeri" runat="server" Height="100" /></span></b></td>
                </tr>
            ...
            <table class="table table-sm">
                ...
                <%
                          ...
                          int kolonsayisi = 1;
                          SqlCommand fcl1 = new SqlCommand("with myResult(sira,Sayi,FCLNO)as(select ROW_NUMBER() OVER( order by FCLNO) as sira, COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli' group by FCLNO)select *from myResult where sira between 1 and 13", con);
                          SqlDataReader fcloku1 = fcl1.ExecuteReader();
                          while (fcloku1.Read())
                          {
                              if (Convert.ToInt32(fcloku1["Sayi"]) == 0)
                ...
                <tr>
                    ...
                    <%
                              SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o left outer join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Id order by o.Id asc", con);
                              SqlDataReader urunoku = uruncek.ExecuteReader();
                              while (urunoku.Read())
                              {%>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b></td>
                    ...
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta yaziboyutu"><b><%=fcloku1["FCLNO"].ToString() %></b> </td>
                    <%
                                  SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,kp.PaletSayisi AS PALET   from KonsimentoProduct kp inner join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod  where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku1["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,kp.PaletSayisi,kp.MamulKodu,o.Id order by o.Id asc", con);
                             SqlDataReader palettoku = palettcek.ExecuteReader();
                             while (palettoku.Read())
                             {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=palettoku["PALET"].ToString() %></b></td>
            ...
            <table class="table table-sm">
                ...
                int enbuyuk = Convert.ToInt32(Session["x"]);
                kolonsayisi = Convert.ToInt32(Session["x"]) + 1;
                SqlCommand fcl11 = new SqlCommand("with myResult(sira,Sayi,FCLNO)as(select ROW_NUMBER() OVER( order by FCLNO) as sira, COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli' group by FCLNO)select *from myResult where sira between 14 and 24", con);
                ...
                <tr>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=kolonsayisi %></b></td>
                    <%
                            SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o left outer join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Id order by o.Id asc", con);
                            SqlDataReader urunoku = uruncek.ExecuteReader();
                            while (urunoku.Read())
                            {%>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b></td>
                    <%}
                             SqlCommand paketcek = new SqlCommand("select  Case  when o.TorbaTipi='YOK' then '' when o.TorbaTipi <> 'YOK' then Convert(varchar, o.TorbaAgirligi)+' '+REPLACE(REPLACE(o.TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba,case  when o.BBTipi='YOK' then '' when o.BBTipi <> 'YOK' then CONVERT(varchar,o.BBAgirligi)+' '+o.BBTipi end as BigBag, case when o.Palet='YOK' then '' when o.Palet <> 'YOK' then 'Pallettized'  end as Palet,'Streched' as Strec,Case when Palet <> 'YOK' then CAST(Palet as int) when Palet ='YOK' then CAST(BBAgirligi as int)     end as NET from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by o.TorbaTipi,o.TorbaAgirligi,o.BBTipi,o.BBAgirligi,o.Palet,k.MamulKodu,o.Id order by o.Id asc", con);
                             SqlDataReader paketoku = paketcek.ExecuteReader();
                             while (paketoku.Read())
                             {%>
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta yaziboyutu"><b><span><%=paketoku["NET"].ToString()+" KGS" %>&nbsp;</span><span><%=paketoku["Torba"].ToString() %></span>&nbsp;<span><%=paketoku["BigBag"].ToString() %></span>&nbsp;<%=paketoku["Palet"].ToString()%>&nbsp;<%=paketoku["Strec"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand PCSCEK = new SqlCommand("select distinct case when o.Palet <> 'YOK' then 'PALLETS' else 'NO PALLETS'   end  as PCS from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'", con);
                                    SqlDataReader PCSOKU = PCSCEK.ExecuteReader();
                                    while (PCSOKU.Read())
                                    {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=PCSOKU["PCS"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand netbrutcek = new SqlCommand("select CAST(SUM(kp.KonteynerdakiTonaj) as decimal(18,0)) as NET,case   when o.Palet <> 'YOK' then CAST(SUM(PaletSayisi*30) as int) when o.Palet ='YOK' then CAST(SUM(PaletSayisi*10) as int) end as BRUT   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by o.Palet,o.BBAgirligi", con);
                                    SqlDataReader netbrutoku = netbrutcek.ExecuteReader();
                                    while (netbrutoku.Read())
                                    {%>
                ...
                <%
                     ...
                     pcek2.Parameters.AddWithValue("@p1", Request.QueryString["teklifno"]);
                     ...
                     SqlCommand netttotal2 = new SqlCommand("select ISNULL(SUM(k.KonteynerdakiTonaj),0) as NET  from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu and k.TeklifNo=o.TeklifNo where o.TeklifNo='" + Request.QueryString["teklifno"] + "'", con);
                     totaldegerler2[1] = Convert.ToDouble(netttotal2.ExecuteScalar());

                     SqlCommand paletlericek2 = new SqlCommand("select CASE  when REPLACE(o.Palet,'YOK',0) <> 0  then ISNULL(CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.Palet as int) AS int),0) when  REPLACE(o.Palet,'YOK',0) = 0 then ISNULL(CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.BBAgirligi as int) AS int),0)  END as PALET  from KonsimentoProduct kp left outer join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod where kp.TeklifNo='" + Request.QueryString["teklifno"] + "'  and kp.SiparisTipi='Tekli'  group by kp.FCLNO,o.Palet,o.BBAgirligi", con);
                     ...
                     paletlerioku2.Close();
                     SqlCommand fclfarklı2 = new SqlCommand("Konsimento_Gros_Total_Tekli", con);
                     fclfarklı2.Parameters.AddWithValue("@TeklifNo", Request.QueryString["teklifno"]);
                     //totaldegerler[2] = totaldegerler[1] + (Convert.ToDouble(fclfarklı.ExecuteScalar()) * 30);
                ...
                <tr>
                 ...
                 pakettipi44.Parameters.AddWithValue("@p1", Request.QueryString["teklifno"]);
                ...
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi"><a href="#" style="color: black; text-decoration: none;" data-toggle="modal" data-target="#modal2">NO OF<br />
                        <span class="kaydiryirmi">FCL</span> </a></span></b></td>
                    <td class="cizgi yaziboyutu" style="height: 15px;" colspan="4"><b><span><%=foot[7] %></span></b></td>
                    <td class="cizgi yaziboyutu orta" style="height: 15px;" colspan="3"><b><span class="kaydiryirmi"><a href="#" style="color: black; text-decoration: none" data-toggle="modal" data-target="#mdl">SPECIAL NOTES</a></span></b></td>

                </tr>
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi"><a href="#" data-toggle="modal" style="color: black; text-decoration: none" data-target=".bs-example-modal-sm">FREE<br />
                        <span class="kaydiryirmi">TIME</span></a> </span></b></td>
                    <td class="cizgi yaziboyutu" style="height: 15px;" colspan="4"><b><span><%=baslik[10] %></span></b></td>
                    <td class="cizgi yaziboyutu" style="vertical-align: top; word-break: break-all;" colspan="3" rowspan="4"><b>
                        <textarea readonly="readonly" class="yaziboyutu orta" rows="9" cols="9" style="background-color: none; background: transparent; overflow: auto; border-color: none; width: 100%; height: 100%;"><%=baslik[7]%></textarea></b></td>
                </tr>
                ...
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi">ORIGIN<br />
                        <span class="kaydiryirmi"></span>OF<br />
                        <span class="kaydiryirmi">GOODS</span> </span></b></td>
                    <td class="cizgi yaziboyutu" style="height: 15px;" colspan="4"><b><span>TURKEY</span></b></td>
                </tr>
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi">PORT OF<br />
                        <span class="kaydiryirmi">LOADING</span> </span></b></td>
                    <td class="cizgi yaziboyutu" style="height: 15px;" colspan="4"><b><span><%=foot[1] %></span></b></td>
                </tr>
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi">PORT OF<br />
                        <span class="kaydiryirmi">DELIVERY</span></span></b></td>
                    <td class="cizgi yaziboyutu" style="height: 15px;" colspan="4"><b><span><%=foot[2] %></span></b></td>
                </tr>
                <tr>
                ...
                {%>
                    ...
                    <td class="cizgi yaziboyutu orta" colspan="3" rowspan="3" style="height: 60px;"><b><span>
                        <asp:Image ID="Image2" Height="100" runat="server" /></span></b></td>
                </tr>
                ...
                <tr>
                    <td class="cizgi yaziboyutu" style="height: 15px;"><b><span class="kaydiryirmi">CLEAN<br />
                        <span class="kaydiryirmi">ON</span>
                        <br />
                        <span class="orta kaydiryirmi">BOARD</span> </span></b></td>
            ...
            <table class="table table-sm">
                ...
                int enbuyuk = 0;
                SqlCommand fcl11 = new SqlCommand("with myResult(sira,Sayi,FCLNO)as(select ROW_NUMBER() OVER( order by FCLNO) as sira, COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli' group by FCLNO)select *from myResult where sira between 14 and 30", con);
                SqlDataReader fcloku11 = fcl11.ExecuteReader();
                while (fcloku11.Read())
                {
                    if (Convert.ToInt32(fcloku11["Sayi"]) == 0)
            ...
            <table class="table table-sm">
                ...
                SqlCommand fcl12 = new SqlCommand("with myResult(sira,Sayi,FCLNO)as(select ROW_NUMBER() OVER( order by FCLNO) as sira, COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli' group by FCLNO)select *from myResult where sira between 31 and 45", con);
                ...
                <tr>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=kolonsayisi %></b></td>
                    <%
                            SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o left outer join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Id order by o.Id asc", con);
                            SqlDataReader urunoku = uruncek.ExecuteReader();
                            while (urunoku.Read())
                            {%>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b></td>
                    <%}
                             SqlCommand paketcek = new SqlCommand("select  Case  when o.TorbaTipi='YOK' then '' when o.TorbaTipi <> 'YOK' then Convert(varchar, o.TorbaAgirligi)+' '+REPLACE(REPLACE(o.TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba,case  when o.BBTipi='YOK' then '' when o.BBTipi <> 'YOK' then CONVERT(varchar,o.BBAgirligi)+' '+o.BBTipi end as BigBag, case when o.Palet='YOK' then '' when o.Palet <> 'YOK' then 'Pallettized'  end as Palet,'Streched' as Strec,Case when Palet <> 'YOK' then CAST(Palet as int) when Palet ='YOK' then CAST(BBAgirligi as int)     end as NET from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by o.TorbaTipi,o.TorbaAgirligi,o.BBTipi,o.BBAgirligi,o.Palet,k.MamulKodu,o.Id order by o.Id asc", con);
                             SqlDataReader paketoku = paketcek.ExecuteReader();
                             while (paketoku.Read())
                             {%>
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta yaziboyutu"><b><span><%=paketoku["NET"].ToString()+" KGS" %>&nbsp;</span><span><%=paketoku["Torba"].ToString() %></span>&nbsp;<span><%=paketoku["BigBag"].ToString() %></span>&nbsp;<%=paketoku["Palet"].ToString()%>&nbsp;<%=paketoku["Strec"].ToString() %></b></td>
                    ...
                    <%
                        SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,CASE  when REPLACE(o.Palet,'YOK',0) <> 0  then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.Palet as int) AS int) when  REPLACE(o.Palet,'YOK',0) = 0 then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.BBAgirligi as int) AS int)  END AS PALET   from KonsimentoProduct kp inner join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod  where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,o.Palet,o.BBAgirligi,kp.MamulKodu,o.Id order by o.Id asc", con);
                             SqlDataReader palettoku = palettcek.ExecuteReader();
                             while (palettoku.Read())
                             {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=palettoku["PALET"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand PCSCEK = new SqlCommand("select distinct case when o.Palet <> 'YOK' then 'PALLETS' else 'NO PALLETS'   end  as PCS from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'", con);
                                    SqlDataReader PCSOKU = PCSCEK.ExecuteReader();
                                    while (PCSOKU.Read())
                                    {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=PCSOKU["PCS"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand netbrutcek = new SqlCommand("select CAST(SUM(kp.KonteynerdakiTonaj) as decimal(18,0)) as NET,case   when o.Palet <> 'YOK' then CAST(SUM(PaletSayisi*30) as int) when o.Palet ='YOK' then CAST(SUM(PaletSayisi*10) as int) end as BRUT   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by o.Palet,o.BBAgirligi", con);
                                    SqlDataReader netbrutoku = netbrutcek.ExecuteReader();
                                    while (netbrutoku.Read())
                                    {%>
                ...
                <tr>
                    ...
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu">
                        <%
                            SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,CASE  when REPLACE(o.Palet,'YOK',0) <> 0  then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.Palet as int) AS int) when  REPLACE(o.Palet,'YOK',0) = 0 then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.BBAgirligi as int) AS int)  END AS PALET   from KonsimentoProduct kp inner join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod  where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku12["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,o.Palet,o.BBAgirligi,kp.MamulKodu", con);
                                                 SqlDataReader palettoku = palettcek.ExecuteReader();
                                                 while (palettoku.Read())
                                                 {%>
                        <b><%=palettoku["PALET"].ToString() %></b><br />
                ...
                {%>
                    ...
                    <td class="cizgi yaziboyutu orta" colspan="3" rowspan="3" style="height: 60px;"><b><span>
                        <asp:Image ID="Image3" Height="100" runat="server" /></span></b></td>
                </tr>
            ...
            <table class="table table-sm">
                ...
                <tr>
                    ...
                    <td class="cizgi orta yaziboyutu"><b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b></td>
                    <%}
                        SqlCommand paketcek = new SqlCommand("select  Case  when o.TorbaTipi='YOK' then '' when o.TorbaTipi <> 'YOK' then Convert(varchar, o.TorbaAgirligi)+' '+REPLACE(REPLACE(o.TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba,case  when o.BBTipi='YOK' then '' when o.BBTipi <> 'YOK' then CONVERT(varchar,o.BBAgirligi)+' '+o.BBTipi end as BigBag, case when o.Palet='YOK' then '' when o.Palet <> 'YOK' then 'Pallettized'  end as Palet,'Streched' as Strec,Case when Palet <> 'YOK' then CAST(Palet as int) when Palet ='YOK' then CAST(BBAgirligi as int)     end as NET from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by o.TorbaTipi,o.TorbaAgirligi,o.BBTipi,o.BBAgirligi,o.Palet,k.MamulKodu,o.Urun,o.Id order by o.Id asc", con);
                             SqlDataReader paketoku = paketcek.ExecuteReader();
                             while (paketoku.Read())
                             {%>
                    <td class="cizgi orta yaziboyutu"><b><span><%=paketoku["NET"].ToString()+" KGS" %>&nbsp;</span><span><%=paketoku["Torba"].ToString() %></span>&nbsp;<span><%=paketoku["BigBag"].ToString() %></span>&nbsp;<%=paketoku["Palet"].ToString()%>&nbsp;<%=paketoku["Strec"].ToString() %></b></td>
                    ...
                    <td class="cizgi orta yaziboyutu"><b><%=fcloku11["FCLNO"].ToString() %></b> </td>
                    <%
                        SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,CASE  when REPLACE(o.Palet,'YOK',0) <> 0  then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.Palet as int) AS int) when  REPLACE(o.Palet,'YOK',0) = 0 then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.BBAgirligi as int) AS int)  END AS PALET   from KonsimentoProduct kp inner join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod  where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,o.Palet,o.BBAgirligi,kp.MamulKodu,o.Urun,o.Id order by o.Id asc", con);
                             SqlDataReader palettoku = palettcek.ExecuteReader();
                             while (palettoku.Read())
                             {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=palettoku["PALET"].ToString() %></b></td>
                    ...
                    %>
                    <%
                        SqlCommand netbrutcek = new SqlCommand("select CAST(SUM(kp.KonteynerdakiTonaj) as decimal(18,0)) as NET,case   when o.Palet <> 'YOK' then CAST(SUM(PaletSayisi*30) as int) when o.Palet ='YOK' then CAST(SUM(PaletSayisi*10) as int) end as BRUT   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by o.Palet,o.BBAgirligi,o.Urun", con);
                                    SqlDataReader netbrutoku = netbrutcek.ExecuteReader();
                                    while (netbrutoku.Read())
                                    {%>
                ...
                <tr>
                    ...
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu">
                        <%
                            SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o left outer join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku11["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Urun,o.Id order by o.Id asc", con);
                             SqlDataReader urunoku = uruncek.ExecuteReader();
                             while (urunoku.Read())
                             {%>
                        <b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b><br />
            ...
            <table class="table table-sm">
                ...
                SqlCommand fcl13 = new SqlCommand("with myResult(sira,Sayi,FCLNO)as(select ROW_NUMBER() OVER( order by FCLNO) as sira, COUNT(FCLNO) as Sayi, FCLNO from KonsimentoProduct where TeklifNo='" + Request.QueryString["teklifno"] + "' and SiparisTipi='Tekli' group by FCLNO)select *from myResult where sira between 45 and 60", con);
                ...
                <tr>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=kolonsayisi %></b></td>
                    <%
                        SqlCommand uruncek = new SqlCommand("select case when o.UrunAnaGrup='18.TALK' then 'TALC' when o.UrunAnaGrup='19.BARİT' then 'BARIUM SULFAT' when o.UrunAnaGrup='15.HİDROFİL' or o.UrunAnaGrup='16.HİDROFİL KAPLI' then 'CALCIUM OXIDE' when o.UrunAnaGrup='23.TİCARİ ÜRÜNLER' then case when o.Urun='PUMICE STONES' then 'PUMICE STONES' end else 'CALCIUM CARBONATE' end as Aciklama,o.Urun from Orders o left outer join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku13["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by k.FCLNO,o.UrunAnaGrup,o.Urun,o.Urun,o.Id order by o.Id asc", con);
                            SqlDataReader urunoku = uruncek.ExecuteReader();
                            while (urunoku.Read())
                            {%>
                    <td style="height: 50px; width: 50px; text-align: center" class="cizgi orta yaziboyutu"><b><%=urunoku["Aciklama"].ToString() %>&nbsp;<%=urunoku["Urun"].ToString() %></b></td>
                    <%}
                        SqlCommand paketcek = new SqlCommand("select  Case  when o.TorbaTipi='YOK' then '' when o.TorbaTipi <> 'YOK' then Convert(varchar, o.TorbaAgirligi)+' '+REPLACE(REPLACE(o.TorbaTipi,'PE li Kraft','KG PE Kraft'),'PE siz Kraft','KG Kraft') end as Torba,case  when o.BBTipi='YOK' then '' when o.BBTipi <> 'YOK' then CONVERT(varchar,o.BBAgirligi)+' '+o.BBTipi end as BigBag, case when o.Palet='YOK' then '' when o.Palet <> 'YOK' then 'Pallettized'  end as Palet,'Streched' as Strec,Case when Palet <> 'YOK' then CAST(Palet as int) when Palet ='YOK' then CAST(BBAgirligi as int)     end as NET from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu  where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku13["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli' group by o.TorbaTipi,o.TorbaAgirligi,o.BBTipi,o.BBAgirligi,o.Palet,k.MamulKodu,o.Urun,o.Id order by o.Id asc", con);
                             SqlDataReader paketoku = paketcek.ExecuteReader();
                             while (paketoku.Read())
                             {%>
                    <td style="height: 50px; width: 300px; text-align: center" class="cizgi orta yaziboyutu"><b><span><%=paketoku["NET"].ToString()+" KGS" %>&nbsp;</span><span><%=paketoku["Torba"].ToString() %></span>&nbsp;<span><%=paketoku["BigBag"].ToString() %></span>&nbsp;<%=paketoku["Palet"].ToString()%>&nbsp;<%=paketoku["Strec"].ToString() %></b></td>
                    ...
                    <%
                        SqlCommand palettcek = new SqlCommand("select  kp.FCLNO,CASE  when REPLACE(o.Palet,'YOK',0) <> 0  then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.Palet as int) AS int) when  REPLACE(o.Palet,'YOK',0) = 0 then CAST(SUM(kp.KonteynerdakiTonaj)/CAST(o.BBAgirligi as int) AS int)  END AS PALET   from KonsimentoProduct kp inner join Orders o on kp.TeklifNo=o.TeklifNo and kp.MamulKodu=o.YediyuzluKod  where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku13["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by kp.FCLNO,o.Palet,o.BBAgirligi,kp.MamulKodu,o.Urun,o.Id order by o.Id asc", con);
                             SqlDataReader palettoku = palettcek.ExecuteReader();
                             while (palettoku.Read())
                             {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=palettoku["PALET"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand PCSCEK = new SqlCommand("select distinct case when o.Palet <> 'YOK' then 'PALLETS' else 'NO PALLETS'   end  as PCS from Orders o inner join KonsimentoProduct k on o.YediyuzluKod=k.MamulKodu where o.TeklifNo='" + Request.QueryString["teklifno"] + "' and k.FCLNO='" + fcloku13["FCLNO"].ToString() + "' and k.SiparisTipi='Tekli'", con);
                                    SqlDataReader PCSOKU = PCSCEK.ExecuteReader();
                                    while (PCSOKU.Read())
                                    {%>
                    <td style="height: 50px; width: 100px;" class="cizgi orta yaziboyutu"><b><%=PCSOKU["PCS"].ToString() %></b></td>
                    ...
                    %>
                    <%
                                    SqlCommand netbrutcek = new SqlCommand("select CAST(SUM(kp.KonteynerdakiTonaj) as decimal(18,0)) as NET,case   when o.Palet <> 'YOK' then CAST(SUM(PaletSayisi*30) as int) when o.Palet ='YOK' then CAST(SUM(PaletSayisi*10) as int) end as BRUT   from KonsimentoProduct kp inner join Orders o on o.TeklifNo=kp.TeklifNo and o.YediyuzluKod=kp.MamulKodu where kp.TeklifNo='" + Request.QueryString["teklifno"] + "' and kp.FCLNO='" + fcloku13["FCLNO"].ToString() + "' and kp.SiparisTipi='Tekli' group by o.Palet,o.BBAgirligi", con);
                                    SqlDataReader netbrutoku = netbrutcek.ExecuteReader();
                                    while (netbrutoku.Read())
                                    {%>
                ...
                {%>
                    ...
                    <td class="cizgi yaziboyutu orta" colspan="3" rowspan="3" style="height: 60px;"><b><span>
                        <asp:Image ID="Image4" Height="100" runat="server" /></span></b></td>
                </tr>
