<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="vade.aspx.cs" Inherits="ExternalTrade.Admin.vade" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
         ...
         .GridTemplate *
                {
                    ...
                    font-size: 12px !important;
                        ...
                        <div class="col-xl-3 col-md-6">
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="Id" Width="580px" Theme="Moderno" CssClass="GridTemplate" >
                            <SettingsBehavior AllowFocusedRow="false" AllowSelectByRowClick="True" AllowDragDrop="false" />
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="Maturity" VisibleIndex="1" Caption="Vade">
                                    </dx:GridViewDataTextColumn>
                                        <dx:GridViewDataTextColumn FieldName="Price" VisibleIndex="2" Caption="Vade Farkı($)">
                                        </dx:GridViewDataTextColumn>
                                </Columns>
                                                            <Styles>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="SELECT * FROM [Maturity]"></asp:SqlDataSource>
