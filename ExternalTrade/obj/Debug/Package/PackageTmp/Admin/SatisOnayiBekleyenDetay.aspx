<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SatisOnayiBekleyenDetay.aspx.cs" Inherits="ExternalTrade.Admin.SatisOnayiBekleyenDetay" %>
    ...
    <script>
      ...
      <script type="text/javascript">
          function successAlert() {
              ...
              }).then(function () { window.location = "SatisOnayiBekleyenDetay.aspx?teklifno=<%=Request.QueryString["teklifno"]%>"; });
          }
</script>
    <script type="text/javascript">
        function errorAlert() {
    ...
    <div class="row" style:"width:100%;">
        ...
        <div class="col-11" style:"width:100%;"><br />
              <div class="form-group row">
                      <div style="width: 1250px; overflow-x: scroll; overflow-y: scroll;">
            ...
            <div class="btn-group">
              ...
              <div class="btn-group">
           <asp:Button ID="Button1" runat="server" Text="SATIŞA DÖNÜŞÜ ONAYLA" CssClass="btn btn-bordered-success" OnClick="Button1_Click" Height="40px"/>
