<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SatisiOnaylananDetay.aspx.cs" Inherits="ExternalTrade.Admin.SatisiOnaylananDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
     ...
     <script>
      ...
      <script type="text/javascript">
          function successAlertRevize() {
              ...
              }).then(function () { window.location = "SatisiOnaylananDetay.aspx?teklifno=<%=Request.QueryString["teklifno"]%>"; });
          }
</script>
    <script type="text/javascript">
        function errorAlert() {
    ...
    <script>
        function SipNo() {
            swal({
                title: "İŞLEM TAMAMLANDI", text: "Sipariş Nuraması Girildi", type: "success"
      ...
      <script>
          function SipNoError() {
              swal({
                  title: "İŞLEM TAMAMLANAMADI", text: "Sipariş Nuraması Girilemedi", type: "error"
              }).then(function () { window.location = "SatisOnaylanan.aspx"; });
          }
    </script>
     <script type="text/javascript">
         function successAlert() {
             swal({
                 title: "İŞLEM TAMAMLANDI", text: "Satış Onayı İptal Edildi", type: "success"
             }).then(function () { window.location = "SatisOnaylanan.aspx"; });
         }
</script>
    <script type="text/javascript">
        function errorAlert() {
            swal({
                title: "İŞLEM TAMAMLANAMADI", text: "Satış Onayı İptal Edilemedi", type: "error"
            });
        }
    ...
    <h1>SATIŞI ONAYLANAN TEKLİFLER DETAY</h1>
    <div  style:"width:100%;">
        <div class="col-11" style:"width:100%;"><br />
              <div class="form-group row">
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll;">
                             
                                           <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" Theme="Moderno" CssClass="GridTemplate"  DataSourceID="SqlDataSource1" KeyFieldName="Id">
