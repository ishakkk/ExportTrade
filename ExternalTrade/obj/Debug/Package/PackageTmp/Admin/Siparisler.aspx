<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Siparisler.aspx.cs" Inherits="ExternalTrade.Admin.Siparisler" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function successAlertRevize() {
            ...
            }).then(function () { window.location = "Siparisler.aspx"; });
        }
    </script>
    <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function TeklifSil() {
            swal({
                title: "İŞLEM TAMAMLANDI", text: "Sipariş Silindi", type: "success"
            }).then(function () { window.location = 'Siparisler.aspx' });
        }
    </script>
  <script>
    ...
    <div class="row" style:"width:100%;">
        <h1>ONAYLANAN TEKLİFLER</h1>
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group row">
                  
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                          <dx:ASPxGridView ID="ASPxGridView1" Width="100%" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="TeklifNo" Theme="Moderno" CssClass="GridTemplate" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared" OnDataBound="ASPxGridView1_DataBound" >
                                            ...
                                            <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="CFR KAR ORANI" ReadOnly="True" VisibleIndex="8" Width="50%">
                                                 ...
                                                 <dx:GridViewDataTextColumn FieldName="TTarih" Caption="TEKLİF TARİHİ" ReadOnly="True" VisibleIndex="9" Width="50%">
                                                   ...
                                                   <dx:GridViewDataTextColumn FieldName="TeklifiOnaylayan" Caption="ONAYLAYAN" ReadOnly="True" VisibleIndex="8" Width="50%">
                                                    <SettingsHeaderFilter Mode="CheckedList">
                                                    </SettingsHeaderFilter>
                                                </dx:GridViewDataTextColumn>
                                            </Columns>
           ...
           <asp:Button ID="btnRapor" runat="server" Text="DETAYLAR" CssClass="btn btn-danger" OnClick="btnRapor_Click" Height="40px"/>
                 ...
                 <%--<input type="button" style="height:40px" data-toggle="modal"  data-target="#exampleModalScrollable" class="btn btn-warning" value="REVİZE ET"/>--%>
                         <input type="button" value="REVİZE ET" class="btn btn-warning" id="btnaciklama" style="height:40px;"/>
 <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server">
            ...
            <div id="aciklama"  style="display:none">
                ...
                <asp:Button ID="btnAciklama" runat="server" CssClass="btn btn-success" Text="KAYDET" OnClick="btnAciklama_Click" Height="40px"/>
            </div>  
        </div>
                    </div>
