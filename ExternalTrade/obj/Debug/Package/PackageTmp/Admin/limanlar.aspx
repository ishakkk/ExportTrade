<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="limanlar.aspx.cs" Inherits="ExternalTrade.Admin.limanlar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
       ...
       <div class="row">
                        ...
                        <div class="col-xl-3 col-md-6">
                            <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="Id" Width="618px" Theme="Moderno" CssClass="GridTemplate" >
                               <SettingsBehavior AllowFocusedRow="false" AllowSelectByRowClick="True" AllowDragDrop="false" />
                                 <Columns>
                                    ...
                                    <dx:GridViewDataTextColumn FieldName="PortName" VisibleIndex="1" Caption="Liman Adı">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="Price" VisibleIndex="2" Caption="Depolama($)">
                                    </dx:GridViewDataTextColumn>
                                    <dx:GridViewDataTextColumn FieldName="InsideTransport" VisibleIndex="3" Caption="İç Nakliye Bedeli($)">
                                    </dx:GridViewDataTextColumn>
                                </Columns>
                                                            <Styles>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="SELECT * FROM [Port]"></asp:SqlDataSource>
</asp:Content>
