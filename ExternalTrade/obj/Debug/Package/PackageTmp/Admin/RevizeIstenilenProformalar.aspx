<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="RevizeIstenilenProformalar.aspx.cs" Inherits="ExternalTrade.Admin.RevizeIstenilenProformalar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
       ...
       <script>
        ...
        <script>
            function SuccessAlertRed() {
                ...
                }).then(function () { window.location = "RevizeIstenilenProformalar.aspx"; });
            }
</script>
    <style type="text/css">
         .GridTemplate *
    ...
    <script>
     ...
     <div class="row" style:"width:100%;">
        <h1>REVİZE İSTENİLEN PROFORMALAR</h1>
