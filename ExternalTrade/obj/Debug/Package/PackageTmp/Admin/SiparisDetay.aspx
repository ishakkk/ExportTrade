<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SiparisDetay.aspx.cs" Inherits="ExternalTrade.Admin.SiparisDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
     <script>
      ...
      <script type="text/javascript">
          function successAlert() {
              swal({
                  title: "İŞLEM TAMAMLANDI", text: "Onay İptal Edildi", type: "success"
              }).then(function () { window.location = "SiparisDetay.aspx?teklifno=<%=Request.QueryString["teklifno"]%>"; });
          }
    </script>
    <script type="text/javascript">
        function errorAlert() {
            swal({
                title: "İŞLEM TAMAMLANAMADI", text: "Onay İptal Edilemedi", type: "error"
            });
        }
    </script>
    <script type="text/javascript">
  ...
  <script>
    ...
    <div class="row" style:"width:100%;">,
        <h1>ONAYLANAN TEKLİFLER DETAY</h1>
        <div class="col-11" style:"width:100%;"><br />
              <div class="form-group row">
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll;">
                         <dx:ASPxGridView ID="ASPxGridView1" Width="100%" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="Id" Theme="Moderno" CssClass="GridTemplate" >
