<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="RevizeIstenilenProformalarDetay.aspx.cs" Inherits="ExternalTrade.RevizeIstenilenProformalarDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
     <div class="row" style:"width:100%;">
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group row"><style type="text/css">
         .GridTemplate *
                {
                    ...
                    font-size: 12px !important;
                      ...
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll;">
                              <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Theme="Material" CssClass="GridTemplate"  KeyFieldName="Id" Width="100%">
...
<dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server">
    ...
    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="SELECT * FROM [Port]"></asp:SqlDataSource>
</asp:Content>
