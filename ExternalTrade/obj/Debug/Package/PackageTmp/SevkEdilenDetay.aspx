<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="SevkEdilenDetay.aspx.cs" Inherits="ExternalTrade.SevkEdilenDetay" %>
 ...
 <div class="row" style:"width:100%;">
        ...
        <script>
            function codeSuccess() {
                ...
                }).then(function () { window.location = 'SevkEdilenDetay.aspx?teklifno=<%=Request.QueryString["teklifno"]%>' });
            }
    </script>
     <style type="text/css">
         .GridTemplate *
                      ...
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                              ...
                              <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="Id" Width="100%" Theme="Moderno" CssClass="GridTemplate" >
                                          ...
                                          <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="KARLILIK" Caption="KAR ORANI" VisibleIndex="61"  Width="100px">
                                                    <SettingsHeaderFilter Mode="CheckedList">
                                                    </SettingsHeaderFilter>
                                                </dx:GridViewDataTextColumn>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="KullaniciSevkDetay" OnSelecting="SqlDataSource1_Selecting" SelectCommandType="StoredProcedure">
     <SelectParameters>
