<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="SatisOnayiBekleyenTekliflerDetay.aspx.cs" Inherits="ExternalTrade.SatisOnayiBekleyenTekliflerDetay" %>
            ...
            swal({
               ...
               <script>
                   function explanationSuccess() {
                       ...
                       }).then(function () { window.location = 'SatisOnayiBekleyenTekliflerDetay.aspx?teklifno=<%=Request.QueryString["teklifno"]%>' });
                   }
    </script>
        <script>
