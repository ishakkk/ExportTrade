<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="OnaylananTekliflerDetay.aspx.cs" Inherits="ExternalTrade.OnaylananTekliflerDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <script>
        function sec() {
            swal({
                ...
                <script>
                    function Successteklifno() {
                        swal({
                            title: "İŞLEM TAMAMLANDI", text: "Teklif Formu Oluşturuldu", type: "success"
                        }).then(function () {
                            window.location = 'TeklifFormu.aspx?teklifno=<%=Request.QueryString["teklifno"]%>'
                        });
                    }
    </script>
    <script>
        function Errorteklifno() {
            swal({
                title: "İŞLEM TAMAMLANAMADI", text: "Teklif Formu Oluşturulamadı", type: "error"
            });
    ...
    <script>
        $(function () {
            $("input[name='checkLanguage']").click(function () {
                $("#chooselanguage").show();
                $("#chkinfo").show();
                $("#chktds").show();
                $("#chkmsds").show();
...
<script>
    ...
    <div class="row" style:"width:100%;">
        <div class="col-11" style="width:100%;"><br />
                         ...
                         <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Theme="Moderno" CssClass="GridTemplate"  KeyFieldName="Id" Width="100%">
                                          ...
                                          <Columns>
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="FobSatisFiyati" VisibleIndex="45" Caption="FOB SATIŞ">
                                                  ...
                                                  <dx:GridViewDataTextColumn FieldName="Urun" VisibleIndex="55" Width="90px" Caption="ÜRÜN">
                                                    <SettingsHeaderFilter Mode="CheckedList">
                                                    </SettingsHeaderFilter>
                                                </dx:GridViewDataTextColumn>
           ...
           <%-- <asp:Button ID="btnTeklifFormuOlustur" runat="server" Text="TEKLİF FORMU OLUŞTUR" CssClass="btn btn-warning" OnClick="btnTeklifFormuOlustur_Click" />--%>
        </div>
