<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SevkEdilenDetay.aspx.cs" Inherits="ExternalTrade.Admin.SevkEdilenDetay" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
 ...
 <dx:ASPxGridViewExporter ID="ASPxGridViewExporter1" runat="server">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="AdminSevkDetay" SelectCommandType="StoredProcedure" OnSelecting="SqlDataSource1_Selecting">
        <SelectParameters>
