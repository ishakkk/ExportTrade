...
{
    public partial class SatisOnaylanan : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                ASPxGridView1.Columns["SatisOnayiVeren"].Visible = false;
            }
        }
        ...
        {
            ASPxGridViewExporter1.WriteXlsxToResponse("Satisi_Onaylanan_Teklif_Listesi_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }
