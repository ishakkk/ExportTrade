<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="IslemGoren2.aspx.cs" Inherits="ExternalTrade.Admin.IslemGoren2" %>
...
from EditOrdersEnd e left outer join Orders o on e.SiparisNo=o.SiparisNo and o.YediyuzluKod=e.YediyuzluKod and o.TeklifNo=e.TeklifNo
          where   o.SiparisNo is not null and o.YediyuzluKod is not null and o.Durum='SATISA DONDU' and e.MusteriKodu not in(select MusteriKodu from DepartmentCustomers) and e.SevkTarihi between @p1 and @p2
