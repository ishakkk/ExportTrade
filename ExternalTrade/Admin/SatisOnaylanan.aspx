<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="SatisOnaylanan.aspx.cs" Inherits="ExternalTrade.Admin.SatisOnaylanan" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
     ...
     <script>
         function SepetSil() {
             ...
             }).then(function () { window.location = 'SatisOnaylanan.aspx'; });
         }
        </script>
       <script>
    ...
    <div  style:"width:100%;">
         <h1>SATIŞI ONAYLANAN TEKLİFLER</h1>
                      ...
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll;">
                              <dx:ASPxGridView ID="ASPxGridView1" runat="server" Width="100%" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="TeklifNo" Theme="Moderno" CssClass="GridTemplate"  OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared">
                                   ...
                                   <SettingsPager PageSize="25">
                                            ...
                                            <dx:GridViewCommandColumn SelectAllCheckboxMode="Page" ShowSelectCheckbox="True" VisibleIndex="0">
                                                ...
                                                <dx:GridViewDataTextColumn FieldName="CFR KAR ORANI" ReadOnly="True" VisibleIndex="8" Width="50%">
                                                 ...
                                                 <dx:GridViewDataTextColumn FieldName="SatisOnayiVeren" Caption="SATIŞ ONAYI VEREN" ReadOnly="True" VisibleIndex="9" Width="60%">
                                               <SettingsHeaderFilter Mode="CheckedList">
                                                    </SettingsHeaderFilter>
                                                      </dx:GridViewDataTextColumn>
                                ...
                                <EditFormColumnCaption Font-Size="X-Small">
                                   ...
                                   <div>
           <asp:Button ID="Button1" runat="server" Text="DETAYLAR" CssClass="btn btn-danger" OnClick="Button1_Click" Height="40px"/>
            <asp:Button ID="Button2" runat="server" Text="REDDET" CssClass="btn btn-dark" OnClick="Button2_Click" Height="40px"/>
             <asp:Button ID="Button3" runat="server" Text="RAPOR AL" CssClass="btn btn-primary" OnClick="Button3_Click" Height="40px"/>
                                       <a href="SatisiOnaylananDetayliRapor.aspx" class="btn btn-success">DETAYLI RAPOR</a>
      ...
      <div id="aciklamadiv"  style="display:none">
                ...
                <asp:Button ID="btnKaydet" runat="server" Text="KAYDET" CssClass="btn btn-success" OnClick="btnKaydet_Click" Height="40px"/>
            </div>
                                        </div>
             
            
             <div id="musterikodu" style="display:none" >
                <asp:TextBox ID="txtMusteriKodu" runat="server" TextMode="MultiLine" CssClass="form-control"></asp:TextBox>
                <asp:Button ID="Button4" runat="server" Text="KAYDET" CssClass="btn btn-success" OnClick="Button4_Click" Height="40px"/>
            </div>
                    </div>
    ...
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="SELECT u.Name+' '+u.SurName as [SatisOnayiVeren], o.[TeklifNo],o.[Temsilci],o.[MusteriIsmi],o.[Ulke],CAST(SUM(o.[buUrununSiparisTonaji]) as decimal(18,3)) as [TOPLAM TONAJ], CAST(SUM(o.[buUrununSiparisTonaji]) as decimal(18,3)) as [TOPLAM TONAJ],case when o.TeklifTipi='EXW' or o.TeklifTipi='FAS' or o.TeklifTipi='FCA' or o.TeklifTipi='FOB' Or o.TeklifTipi='YOK'  or  o.TeklifTipi='DAT' then CAST((SUM(o.[KalemSatisFiyati])-SUM(o.[KalemMaliyeti]))/SUM(o.[KalemMaliyeti]) as decimal(18,3)) when o.TeklifTipi='CFR' Or o.TeklifTipi='CIF' or  o.TeklifTipi='DAP' then CAST((SUM(o.[FobSatisFiyati])-SUM(o.[FobMaliyet]))/SUM(o.[FobMaliyet]) as decimal(18,3))  end AS [FOB KAR ORANI],case  when o.TeklifTipi='CFR' Or o.TeklifTipi='CIF' or  o.TeklifTipi='DAP'  then CAST((SUM(o.[KalemSatisFiyati])-SUM(o.[KalemMaliyeti]))/SUM(o.[KalemMaliyeti]) as decimal(18,3)) end AS [CFR KAR ORANI],o.TTarih,o.TeklifTipi,DATEDIFF(day,TTarih,ISNULL(SatisOnayiGondermeTarihi,TTarih)) as TarihFarki FROM [Orders] o left outer join Users u on o.SatisOnayiVeren=u.Id where o.[Durum]=@Durum and o.KILIT=0 group by o.[TeklifNo],o.[Temsilci],o.[MusteriIsmi],o.[Ulke],u.Name+' '+u.SurName,o.TTarih,o.TeklifTipi,SatisOnayiGondermeTarihi order by o.TTarih desc" OnSelecting="SqlDataSource1_Selecting">
        <SelectParameters>
