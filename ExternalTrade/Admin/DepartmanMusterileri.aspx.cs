...
{
    public partial class DepartmanMusterileri : System.Web.UI.Page
    {
        ...
        {
            if (db.DepartmanMusterileriRaporlama(Convert.ToDateTime(txttar1.Text), Convert.ToDateTime(txttar2.Text)) == 1)
            {
        ...
        {
            ASPxGridViewExporter1.WriteXlsxToResponse("Departman_Müşterileri" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }
