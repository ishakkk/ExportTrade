...
namespace ExternalTrade.Admin
{
    public partial class SiparisDetay : System.Web.UI.Page
    {
        ...
        {
            ASPxGridView1.Columns["UrunAnaGrup"].Visible = true;
            ...
            ASPxGridViewExporter1.WriteXlsxToResponse("Sipariş_Listesi_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
            ASPxGridView1.Columns["UrunAnaGrup"].Visible = false;
        }
