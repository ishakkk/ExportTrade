...
{
    public partial class GonderimCesitKarlilik : System.Web.UI.Page
    {
        ...
        {
            ASPxGridViewExporter1.WriteXlsxToResponse("Gonderim_Cesit_Karliligi_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }

        protected void btnCek_Click(object sender, EventArgs e)
        {
            if (db.GonderimSekliKarlilik(Convert.ToDateTime(txttar1.Text), Convert.ToDateTime(txttar2.Text)) == 1)
            {
