...
{
    public partial class ReddedilenDetay : System.Web.UI.Page
    {
        ...
        protected void btnRapor_Click(object sender, EventArgs e)
        {
            ...
            ASPxGridViewExporter1.WriteXlsToResponse("Reddedilen_Detay_Listesi_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }
    }
}