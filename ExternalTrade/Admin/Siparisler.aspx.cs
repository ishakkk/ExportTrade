    ...
    public partial class Siparisler : System.Web.UI.Page
    {
        ...
        protected void btnRapor_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Redirect("SiparisDetay.aspx?teklifno=" + teklifno + "");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                if (ASPxGridView1.VisibleRowCount == 1)
                {
                    ...
                    var teklif_no = ASPxGridView1.GetSelectedFieldValues("TeklifNo");
                    teklifno = Convert.ToString(teklif_no[0]);
                    if (db.HayaletKayitSil(teklifno, Convert.ToInt32(UserData.Id)) == 1)
                    {
        ...
        {
            ASPxGridViewExporter1.WriteXlsxToResponse("Onaylanan_Teklif_Listesi_" + DateTime.Now.Year.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Day.ToString());
        }
        ...
        protected void btnAciklama_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (db.AciklamaEkle(Convert.ToString(txtAciklama.Text), teklifno, metin, kimicin, gelen, durum, Convert.ToInt32(UserData.Id)) == 1)
                {
