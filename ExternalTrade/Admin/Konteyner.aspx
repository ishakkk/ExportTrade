<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Konteyner.aspx.cs" Inherits="ExternalTrade.Admin.Konteyner" %>
         ...
         .GridTemplate *
                {
                    ...
                    font-size: 12px !important;
                     ...
                     <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Width="100%" KeyFieldName="SİPARİŞ NO" Theme="Moderno" CssClass="GridTemplate" >
            ...
            <div class="btn-group">
              ...
              <div class="btn-group">
                  ...
                  <a href="Konteyner.aspx" class="btn btn-success" style="height:40px;">YENİLE</a>
       </div>
             
              
        
 
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ExternalTradeDBConnectionString %>" SelectCommand="AdminKonteyner"  SelectCommandType="StoredProcedure">
    </asp:SqlDataSource>
