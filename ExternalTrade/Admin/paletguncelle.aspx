<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="paletguncelle.aspx.cs" Inherits="ExternalTrade.Admin.paletguncelle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="head" runat="server">
    <script type="text/javascript">
        function successAlert() {
            ...
            }).then(function () { window.location = "palet.aspx"; });
        }
</script>
    <script type="text/javascript">
        function errorAlert() {
...
<div>
    <div><label>Palet Fiyatı</label></div>
