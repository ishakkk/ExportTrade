...
{
    public partial class IslemGoren2 : System.Web.UI.Page
    {
        ...
        {
            e.Command.Parameters["@p1"].Value = Request.QueryString["tar1"];
            e.Command.Parameters["@p2"].Value = Request.QueryString["tar2"];
        }
    }
}