<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Teklifler.aspx.cs" Inherits="ExternalTrade.Admin.Teklifler" %>
     ...
     <script type="text/javascript">
         function successAlertRevize() {
             swal({
                 ...
                 window.location = "Teklifler.aspx";
             });
       ...
       <script type="text/javascript">
           function errorAlertRevize() {
               swal({
                   title: "İŞLEM TANAMADI", text: "Teklif Revizeye Gönderilemedi", type: "error"
               }).then(function () {
...
<script>
    ...
    <div class="row" style:"width:100%;">
        <h1>ONAY BEKLEYEN TEKLİFLER</h1>
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group row" style="width:100%">
                  
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                          <dx:ASPxGridView ID="ASPxGridView1" Width="100%" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" KeyFieldName="TeklifNo" Theme="Moderno" CssClass="GridTemplate" OnHtmlDataCellPrepared="ASPxGridView1_HtmlDataCellPrepared">
