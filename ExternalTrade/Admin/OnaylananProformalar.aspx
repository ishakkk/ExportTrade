<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="OnaylananProformalar.aspx.cs" Inherits="ExternalTrade.Admin.OnaylananProformalar" %>
   ...
   <script>
     ...
     <script>
        ...
        <script>
            function SuccessAlertRevize() {
                ...
                }).then(function () { window.location = "OnaylananProformalar.aspx"; });
            }
</script>
        <script>
            function success() {
    ...
    <style type="text/css">
     ...
     <div class="row" style:"width:100%;">
        <h1>ONAYLANAN PROFORMALAR</h1>
        <div class="col-11" style="width:100%;"><br />
              <div class="form-group row">
                  
                      <div style="width: 100%; overflow-x: scroll; overflow-y: scroll; text-align:center">
                           <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" Width="100%" DataSourceID="SqlDataSource1" KeyFieldName="TeklifNo" Theme="Moderno" CssClass="GridTemplate" >
               ...
               <asp:Button ID="btnProformaGor" runat="server" Text="PROFORMAYI GÖR" CssClass="btn btn-primary" Height="40px" OnClick="btnProformaGor_Click"/>
                 ...
                 <asp:Button ID="Button1" runat="server" Text="REDDET" CssClass="btn btn-dark" Height="40px" OnClick="Button1_Click" />
                  
                  <asp:Button ID="Button2" runat="server" Text="REVİZE ET" CssClass="btn btn-success" Height="40px" OnClick="Button2_Click" />
