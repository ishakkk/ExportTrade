<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="OnayBekleyenTekliflerDetay.aspx.cs" Inherits="ExternalTrade.OnayBekleyenTekliflerDetay" %>
...
<script>
    function successAlert() {
        ...
        }).then(function () { window.location = "OnayBekleyenTekliflerDetay.asxp?teklifno=<%=Request.QueryString["teklifno"]%>" });
    }
</script>
<script>
    function errorAlert() {
...
<script>
    ...
    <div class="row" style:"width:100%;height:100%;">
      ...
      <div id="txt" style="display:none">
              ...
              <div>
                  <asp:Button ID="Button1" runat="server" CssClass="btn btn-primary" OnClick="btnAciklama_Click" Text="KAYDET" Height="40px"/>
              </div>
          </div>
